...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña proporcionada se ha visto comprometida en una filtración de datos. Por favor elija una contraseña diferente.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'qr_key' => [
            'exists' => 'Contenedor de reciclaje no encontrado. Por favor escanee un código QR válido.',
        ],
    ],
